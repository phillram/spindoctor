...
| `gui_curate_regions` | User-chosen ScreenScraper region tickboxes on the Curate tab (list[str], default `[]`). Empty list falls back to the top-level `region_preferences`. |
