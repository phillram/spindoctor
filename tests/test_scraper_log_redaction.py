...
def _make_urllib3_error(sspassword: str, devpassword: str) -> Exception:
    ...
    url = (
        ...
        f"?devid=nobulnela&devpassword={devpassword}"
        f"&softname=SpinDoctor&ssid=nobulnela&sspassword={sspassword}"
...
def test_redact_error_str_removes_sspassword():
    password = "cFWBfonha7oNaPw"
    devpass = "IAUpSfMjjAe"
    params = {"sspassword": password, "devpassword": devpass, "ssid": "nobulnela"}
...
def test_redact_error_str_thegamesdb_apikey():
    apikey = "9f57f2d9ea6d713c4ffcb4c8d718d91ffecfb1bd"
